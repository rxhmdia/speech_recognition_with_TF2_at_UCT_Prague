...
class FeatureExtractor:
    ...
    @staticmethod
    def plot_cepstra(cepstral_data, nplots=3, framestride=0.01, axes=plt):
        ...
        for i in range(nplots):
            ...
            axes.pcolormesh(tspan, ncepstra, cepstral_data[i].T, cmap='rainbow')
            plt.title('Mel-frequency coefficients'.format(i))
            plt.xlabel('Time (s)')
